...
> **生成时间**: 2026-08-17T11:32:24.047832
> **状态**: PHub body 加密格式已澄清（v2 MD5 公式仅适用于 XUDT/legacy；PHub 生产路径为 RSA-wrapped random AES key）
> **关键阻碍**: AES 密钥来源无法确定 (可能来自 ConfigHub 下发)
> **最有效突破**: Wireshark 抓 1 个真实 PHub 请求
...
6. ## 6. 公开资料调研
7. ## 7. captcha_sign 测试
8. ## 8. captcha_sign 单元测试
9. ## 9. PHub HTTP PoC v1
10. ## 10. PHub HTTP PoC v2
11. ## 11. PHub HTTP PoC v3
12. ## 12. PHub HTTP PoC v4
13. ## 13. XBTPackage vtable 反汇编
14. ## 14. 加密函数反汇编
15. ## 15. PHub/SHub 命令分析
16. ## 16. Http.dll 反汇编脚本
17. ## 17. Ghidra 反编译脚本
18. ## 18. alist thunder driver (util.go)
19. ## 19. alist thunder driver (driver.go)
20. ## 20. alist thunder driver (types.go)
21. ## 21. XBTPackage vtable 反汇编结果
22. ## 22. PHub/SHub 命令分析结果
...
**路径**: `research/p2p_recon/FINAL_REPORT.md`
...
**路径**: `research/p2p_recon/PROGRESS_REPORT_v3.md`
...
**路径**: `research/p2p_recon/PROGRESS_REPORT_v2.md`
...
**路径**: `research/p2p_recon/HTTP_DLL_REPORT.md`
...
**路径**: `research/p2p_recon/RESEARCH_STATE.md`
...
**路径**: `research/p2p_recon/PUBLIC_INTEL_REPORT.md`
...
**路径**: `scripts/p2p_recon/test_captcha_sign.py`
...
**路径**: `scripts/p2p_recon/test_captcha_sign_unit.py`
...
**路径**: `scripts/p2p_recon/poc_phub_http_client.py`
...
**路径**: `scripts/p2p_recon/poc_phub_http_v2.py`
...
**路径**: `scripts/p2p_recon/poc_phub_http_v3.py`
...
**路径**: `scripts/p2p_recon/poc_phub_http_v4.py`
...
## 13. XBTPackage vtable 反汇编

**路径**: `scripts/p2p_recon/disasm_xbtpackage_vtables.py`
...
**路径**: `scripts/p2p_recon/disasm_crypto.py`
...
**路径**: `scripts/p2p_recon/disasm_phub_shub_cmds.py`
...
**路径**: `scripts/p2p_recon/disasm_http_dll.py`
...
**路径**: `scripts/p2p_recon/ghidra_decompile.py`
...
## 18. alist thunder driver (util.go)

**路径**: `research/p2p_recon/alist_src/util_main.go`
...
## 19. alist thunder driver (driver.go)

**路径**: `research/p2p_recon/alist_src/driver_main.go`
...
**路径**: `research/p2p_recon/alist_src/types_main.go`
...
## 21. XBTPackage vtable 反汇编结果

**路径**: `research/p2p_recon/xbtpackage_vtables.json`
...
**路径**: `research/p2p_recon/phub_shub_cmd_analysis.json`
